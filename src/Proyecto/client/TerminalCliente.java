...
public class TerminalCliente {
    ...
    /**
     * Obtiene los precios de todas las criptomonedas monitoreadas
     *
    ...
    public String obtenerPreciosMonitoreados() throws Exception {
        ...
        if (precios.isEmpty()) {
            return "No hay precios disponibles en este momento.";
        }

        StringBuilder resultado = new StringBuilder();
        resultado.append("Precios actuales en USD:\n");
        resultado.append("╔════════╦═══════════════╗\n");
